            ...
            >
                <div className='flex items-center justify-between w-full overflow-hidden' >
                    ...
                    <div className='justify-end flex gap-6 items-center' >
                        ...
                        <button onClick={() => switchSidebarTabs("Add to Contacts")} className='text-[15px] text-zinc-700 font-semibold font-sans whitespace-nowrap hidden lg:block italic select-none' >Call <a className='text-blue-300 px-1' href="tel:"> 1-800-555-0101 </a> </button>
                        <Link href="/about" >
                            <button className='text-[15px] text-zinc-700  font-semibold select-none font-sans whitespace-nowrap hidden lg:block' >About</button>
                        </Link>
