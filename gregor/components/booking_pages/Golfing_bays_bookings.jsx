...
const Golfing_bays_bookings = () => {
    ...
    return (
        <div className={`h-[calc(100vh-60px)] overflow-y-scroll px-[10px] lg:px-[30px] relative pt-[100px] lg:pt-[30px] pb-[40px] lg:pb-[120px] ${styles.scrollBar}`} >
            ...
            <div className=' bg-white  w-[90vw] md:w-full flex justify-between items-center' >
                ...
                <div className=''>
                    <div className='w-full flex gap-4'>
                        <button
                            className={`px-[10px] lg:px-[15px] py-[4px] lg:py-[6px]  text-white text-[20px] font-semibold rounded-md  grid place-items-center transition-all ${getDateWithoutTime(booking_date) <= getDateWithoutTime(currentDate) ? "bg-stone-300" : "bg-stone-500 active:opacity-60 hover:opacity-75"}`}
                        ...
                        <button
                            className={`px-[10px] lg:px-[15px] py-[4px] lg:py-[6px]    text-white text-[20px] font-semibold rounded-md  grid place-items-center transition-all ${getDateWithoutTime(booking_date) >= getDateWithoutTime(maxDate) ? "bg-stone-300" : "bg-stone-500 active:opacity-60 hover:opacity-75"}`}
            ...
            <div className='fixed bottom-[60px] lg:bottom-[40px] z-[10]  left-0 right-0 flex justify-center'>
                <button
                    ...
                    className='w-[90vw] md:w-[350px] py-[8px] bg-blue-500 text-white rounded-md text-[17px] font-semibold hover:bg-blue-400 active:bg-blue-300 transition-all'
                >
                    Book slot
                </button>
            </div>
